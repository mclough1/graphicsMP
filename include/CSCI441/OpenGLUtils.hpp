...
namespace CSCI441 {
    ...
    /**	@brief Multiplies current matrix by inverse of given matrix
		...
		/** @brief Creates a 4x4 matrix equal to the identity
		 *
		 * @return glm::mat4 mtx		- matrix set to identity
		 */
		glm::mat4 identityMatrixMat4();
...
inline glm::mat4 CSCI441::identityMatrixMat4() {
